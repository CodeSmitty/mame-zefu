module Features
  module ClearanceHelpers
    def reset_password_for(email)
      ...
      click_link_or_button I18n.t('helpers.submit.password.submit')
    end
    ...
    def sign_out
      click_link_or_button I18n.t('layouts.application.sign_out')
    end
    ...
    def sign_up_with(email, password)
      ...
      click_link_or_button I18n.t('helpers.submit.user.create')
    end
